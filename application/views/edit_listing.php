...
<div id="container">
	...
	<?php echo form_open('listings/editListing/' . $listing->id, array('class' => 'edit_listing', 'id' => 'edit-listing', 'name' => 'edit_listing'));?>
			...
			<?php    
				$data = array( 
					'name' => 'name', 
					'size' => '40', 
					'value' => set_value('name', $listing->name),
					'id' => 'name'
				); 
		...
		<?php echo form_dropdown('category', $options, set_value('category', $listing->category));?>
		<br /><br />
			...
			<?php 
				$data1 = array( 
					'name' => 'text', 
					'id' => 'text',
					'value' => set_value('text', $listing->text)
				); 
				...
				<div class="span4">
					<div id="logo">
						...
						<?php if(!empty($listing->image)) :?>
							<img src="<?php echo base_url()?>images/listing/<?php echo $listing->image_litle?>">
							<input type="hidden" name="image2" value="<?php echo $listing->image_litle;?>">
							<input type="hidden" name="image1" value="<?php echo $listing->image;?>">							
						<?php endif;?>
					</div>
		...
		<?php echo form_dropdown('time', $options1, set_value('time', $listing->time));?>
		...
		<?php    
			$data2 = array( 
				'name' => 'tel', 
				'size' => '40', 
				'value' => set_value('tel', $listing->tel),
				'id' => 'tel'
			); 
		...
		<?php    
			$data2 = array( 
				'name' => 'country', 
				'size' => '40', 
				'value' => set_value('country', $listing->country),
				'id' => 'country'
			); 
			echo form_input($data2);    
		...
		?>
		<br /><br />		
		<?php echo form_submit('ok', 'Редактировать объявление');?>
		<br />
    <?php echo form_close();?>
</div>	
