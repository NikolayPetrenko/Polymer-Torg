...
class Default_Lib_Image {
    ...
    public function __construct() {
    	$ci =& get_instance();
//    	$this->_cacheFolder = '../' . $ci->config->item('app.staticHost.folder') . $this->_cacheFolder;
//    	$this->_noimagePath = '../' . $ci->config->item('app.staticHost.folder') . $this->_noimagePath;
        //нахуй она тут нужна??
    }
